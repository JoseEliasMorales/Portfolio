    ...
    <section id='Contact' className='flex flex-col items-center justify-center py-10 gap-8'>
      ...
      <form className='w-[400px] flex flex-col gap-6'>
        ...
        <div className='w-full flex justify-between'>
          <input type='email' placeholder={info.labelEmail} className='font-Quicksand border-2 border-ligthBrand100 rounded-md py-[10px] font-medium outline-none placeholder:text-ligthBrand100 text-greyBrand500 pl-3  focus:border-orangeBrand200 focus:shadow-md focus:shadow-orangeBrand200' />
          <input type='text' placeholder={info.labelSubject} className='font-Quicksand border-2 border-ligthBrand100 rounded-md py-[10px] font-medium outline-none placeholder:text-ligthBrand100 text-greyBrand500 pl-3  focus:border-orangeBrand200 focus:shadow-md focus:shadow-orangeBrand200' />
        </div>
